...
function initStore() {
  // Employee records are managed by the API. Remove the legacy sample list so
  // it cannot be offered as a host anywhere in the frontend.
  localStorage.removeItem(KEYS.employees);
  // Visitor and visit records come from the backend. Clear the old browser-only sample data.
